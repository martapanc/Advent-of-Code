...
internal class Day17KtTest {
    ...
    private val testInputLines = readInputLineByLine("src/main/kotlin/aoc2023/day17/assets/input0")
    private val testInput = parse(testInputLines)

    private val inputLines = readInputLineByLine("src/main/kotlin/aoc2023/day17/assets/input")
