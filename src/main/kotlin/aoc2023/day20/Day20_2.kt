...
fun main() {
    val input = readInputLineByLine("src/main/kotlin/aoc2023/day20/assets/input")
    data class Module(val type: Char, val dest: List<String>)
    val name2mod = HashMap<String, Module>()
