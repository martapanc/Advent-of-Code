...
internal class Day16KtTest {
    ...
    private val testInputLines = readInputLineByLine("src/main/kotlin/aoc2023/day16/assets/input0")
    private val testInput = parse(testInputLines)

    private val inputLines = readInputLineByLine("src/main/kotlin/aoc2023/day16/assets/input")
