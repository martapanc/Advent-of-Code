...
internal class Day23KtTest {
    ...
    private val testInputLines = readInputLineByLine("src/main/kotlin/aoc2023/day23/assets/input0")
    private val testInput = parse(testInputLines)

    private val inputLines = readInputLineByLine("src/main/kotlin/aoc2023/day23/assets/input")
