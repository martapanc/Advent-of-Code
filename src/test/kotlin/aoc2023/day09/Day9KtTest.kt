...
internal class Day9KtTest {
    ...
    private val testInput0 = readInputLineByLine("src/main/kotlin/aoc2023/day09/assets/input0")
    private val testInput = readInputLineByLine("src/main/kotlin/aoc2023/day09/assets/input")
