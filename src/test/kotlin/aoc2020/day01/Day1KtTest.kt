...
internal class Day1KtTest {
    ...
    private val testInputMap = readInputFileToMap("src/main/kotlin/aoc2020/day01/input0")
    private val inputMap = readInputFileToMap("src/main/kotlin/aoc2020/day01/input")
